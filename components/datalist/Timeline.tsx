...
const Timeline: FC<HomeFeeds> = ({ active, all, art, photos, books, creators }) => {
        ...
        <section className="pt-4">
            <div className="container">
                ...
                <div className="row gx-4 gy-4 mt-1">
                    {activetab == null && all.length > 0 && all.slice(0,8).map((nft, index) => <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3" key={nft.id}>
                    ...
                    {activetab == 'art' && art.length > 0 && art.slice(0,8).map((nft, index) => <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3" key={nft.id}>
                        <div className="card bg-dark border-dark nft-card">
                            <div className="px-3 pt-3">
                                <Link href={`/item/${nft.id}`}>
                                    <Image src={nft.image} alt='nft_image' width={500} height={400} />
                    ...
                    {activetab == 'photography' && photos.length > 0 && photos.slice(0,8).map((nft, index) => <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3" key={nft.id}>
                        <div className="card bg-dark border-dark nft-card">
                            <div className="px-3 pt-3">
                                <Link href={`/item/${nft.id}`}>
                                    <Image src={nft.image} alt='nft_image' width={500} height={400} />
                    ...
                    {activetab == 'books' && books.length > 0 && books.slice(0,8).map((nft, index) => <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3" key={nft.id}>
                        <div className="card bg-dark border-dark nft-card">
                            <div className="px-3 pt-3">
                                <Link href={`/item/${nft.id}`}>
                                    <Image src={nft.image} alt='nft_image' width={500} height={400} />
                    ...
                    {/* {!categoryList.includes(activetab) && all.length > 0 && all.slice(0,8).map((nft, index) => <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 col-xxl-3" key={nft.id}>
                        <div className="card bg-dark border-dark nft-card">
                            <div className="px-3 pt-3">
                                <Link href={`/item/${nft.id}`}>
                                    <Image src={nft.image} alt='nft_image' width={500} height={400} />
                ...
                <p className="my-5 text-center"><Link className="btn btn-primary btn-lg px-3" href="/explore">Explore NFTs</Link></p>
            </div>
            <div className={creators.length > 0 ? "container pt-3 mb-4" : "container pt-3 mb-4 d-none"}>
                ...
                <div className="items-container d-flex pb-3">
                    {creators.length > 0 && creators.map((creator, index) => <div className="card bg-dark border-dark user-card" style={{borderRadius: 20}} key={creator.id}>
                        <Image className="card-img-top w-100 d-block cover-img" src={creator.cover} width={298} height={100} alt='user_cover' />
                        <div className="card-body">
                            <div style={{marginTop: '-55px'}}>
                                <div className="position-relative d-flex justify-content-center align-items-center user-pix-cover">
                                    <Image style={{objectFit: 'cover', borderRadius: 15}} src={creator.dp} width={60} height={60} alt='profile_picture' />
                                ...
                                <Link className="btn btn-primary mb-2" href={`/${creator.username}`}>Visit Profile</Link>
                            </div>
                        </div>
                    </div>)}
                </div>
