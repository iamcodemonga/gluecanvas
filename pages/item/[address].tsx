...
export const getServerSideProps: GetServerSideProps<PageProps> = async(context: GetServerSidePropsContext) => {
    ...
    const item = await ItemDetails(params.address);
            ...
            <section className="py-5" style={{overflowX: 'hidden'}}>
                <div className="container">
                                ...
                                <div>
                                    ...
                                    <div className="d-flex align-items-center mt-1 mb-3">
                                        <div className="position-relative me-2" style={{height: 40, width: 40}}>
                                            <img width="40px" height="40px" style={{objectFit: 'cover', borderRadius: 10}} src={item.creator.dp} />
                    ...
                    <div className="items-container d-flex pb-3">
                        {others && others.map((nft: Post) => <div className="card bg-dark border-dark nft-card slide">
                            ...
                            <div className="card-body">
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="me-2 position-relative">
                                        <img width="30px" height="30px" src={nft.creator.dp} style={{borderRadius: 10, objectFit: 'cover'}} />
                        ...
                        <div className="card bg-dark border-dark nft-card slide d-none">
                            <div className="px-3 pt-3"><a href="item.html"><img src="https://images.pexels.com/photos/959314/pexels-photo-959314.jpeg?auto=compress&cs=tinysrgb&w=800" /></a></div>
                            <div className="card-body">
                        ...
                        <div className="card bg-dark border-dark nft-card slide d-none">
                            <div className="px-3 pt-3"><a href="item.html"><img src="https://images.pexels.com/photos/595747/pexels-photo-595747.jpeg?auto=compress&cs=tinysrgb&w=800" /></a></div>
                            <div className="card-body">
                            <h6 className="card-title mt-1 mb-3"><a className="text-decoration-none text-light" href="#">Beautiful things happen</a></h6>
                            <div className="d-flex align-items-center">
                                <div className="me-2 position-relative"><img width="30px" height="30px" src="https://images.pexels.com/photos/12513230/pexels-photo-12513230.jpeg?auto=compress&cs=tinysrgb&w=800" style={{borderRadius: 10, objectFit: 'cover'}} /><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-patch-check-fill text-primary position-absolute card-batch" style={{fontSize: 15}}>
                        ...
                        <div className="card bg-dark border-dark nft-card slide d-none">
                            <div className="px-3 pt-3"><a href="item.html"><img src="https://images.pexels.com/photos/1727658/pexels-photo-1727658.jpeg?auto=compress&cs=tinysrgb&w=800" /></a></div>
                            <div className="card-body">
                            <h6 className="card-title mt-1 mb-3"><a className="text-decoration-none text-light" href="#">Beautiful things happen</a></h6>
                            <div className="d-flex align-items-center">
                                <div className="me-2 position-relative"><img width="30px" height="30px" src="https://images.pexels.com/photos/12513230/pexels-photo-12513230.jpeg?auto=compress&cs=tinysrgb&w=800" style={{borderRadius: 10, objectFit: 'cover'}} /><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-patch-check-fill text-primary position-absolute card-batch" style={{fontSize: 15}}>
                        ...
                        <div className="card bg-dark border-dark nft-card slide d-none">
                            <div className="px-3 pt-3"><a href="item.html"><img src="https://images.pexels.com/photos/288099/pexels-photo-288099.jpeg?auto=compress&cs=tinysrgb&w=800" /></a></div>
                            <div className="card-body">
                            <h6 className="card-title mt-1 mb-3"><a className="text-decoration-none text-light" href="#">Beautiful things happen</a></h6>
                            <div className="d-flex align-items-center">
                                <div className="me-2 position-relative"><img width="30px" height="30px" src="https://images.pexels.com/photos/12513230/pexels-photo-12513230.jpeg?auto=compress&cs=tinysrgb&w=800" style={{borderRadius: 10, objectFit: 'cover'}} /><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-patch-check-fill text-primary position-absolute card-batch" style={{fontSize: 15}}>
                        ...
                        <div className="card bg-dark border-dark nft-card slide d-none">
                            <div className="px-3 pt-3"><a href="item.html"><img src="https://images.pexels.com/photos/166277/pexels-photo-166277.jpeg?auto=compress&cs=tinysrgb&w=800" /></a></div>
                            <div className="card-body">
                            <h6 className="card-title mt-1 mb-3"><a className="text-decoration-none text-light" href="#">Beautiful things happen</a></h6>
                            <div className="d-flex align-items-center">
                                <div className="me-2 position-relative"><img width="30px" height="30px" src="https://images.pexels.com/photos/12513230/pexels-photo-12513230.jpeg?auto=compress&cs=tinysrgb&w=800" style={{borderRadius: 10, objectFit: 'cover'}} /><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" className="bi bi-patch-check-fill text-primary position-absolute card-batch">
                                    <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z" />
                                </svg></div>
                                <div>
                                <p className="my-0"><a className="username text-white-50 text-decoration-none" href="#">@codemonga</a></p>
